        ...
        <div className="flex flex-col items-center justify-center min-h-screen bg-gray-900 text-white p-4">
            <div className="w-full max-w-4xl bg-gray-800 p-8 rounded-lg shadow-lg">
                <div className="flex justify-between items-center mb-6">
                    <h2 className="text-2xl font-bold text-purple-400">Presentation Phase</h2>
                    <div className="text-gray-400">
                        Report {currentPresentationIndex + 1} of {reports.length}
                    </div>
                </div>
                ...
                <div className="bg-black p-8 rounded border border-gray-700 font-mono text-gray-300 space-y-6 max-h-[70vh] overflow-y-auto">
                    <div className="border-b border-gray-700 pb-4">
                        ...
                        <p className="text-sm text-gray-500">Author: {owner?.name || "Unknown"}</p>
                    </div>

                    {/* Constraints Info (Revealed now) */}
                    <div className="bg-gray-900 p-4 rounded border border-gray-800">
                        <h3 className="text-sm font-bold text-yellow-500 mb-2 uppercase tracking-wider">Declassified Information</h3>
                    ...
                    <div className="space-y-4">
                        <div>
                            <h3 className="text-lg font-bold text-white uppercase">Special Containment Procedures</h3>
                            <p className="whitespace-pre-wrap">{currentReport.containmentProcedures}</p>
                        </div>

                        <div>
                            <h3 className="text-lg font-bold text-white uppercase">Description</h3>
                        ...
                        <div>
                            <h3 className="text-lg font-bold text-white uppercase">Addendum / Conclusion</h3>
                ...
                {isHost && (
                    ...
                    >
                        {currentPresentationIndex < reports.length - 1 ? "Next Report" : "Proceed to Voting"}
                    </button>
                )}
            </div>
        </div>
